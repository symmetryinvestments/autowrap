...
import autowrap.types : isModule, Modules, LibraryName, RootNamespace, OutputFileName;
...
private final class CSharpNamespace {
    ...
    // This class aggregates all wrapped free (global) D functions
...
public string generateCSharp(Modules...)(LibraryName libraryName, RootNamespace rootNamespace) if(allSatisfy!(isModule, Modules)) {
    ...
    string ret;
    enum banner = `// Auto generated by autowrap. Please do not edit by hand.` ~ "\n\n";
    ret ~= banner;
